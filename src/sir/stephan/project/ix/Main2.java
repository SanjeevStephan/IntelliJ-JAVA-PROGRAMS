 ...
 */
package sir.stephan.project.ix;
// Java Classes from the package : STS.sir.stephan.project.ix.chapter4
import sir.stephan.project.ix.chapter4.StudentBioData;
import sir.stephan.project.ix.chapter4.CalculateSum;
import sir.stephan.project.ix.chapter4.AreaOfSquare;
import sir.stephan.project.ix.chapter4.CalculateGST;
import sir.stephan.project.ix.chapter4.CalculateDiscount;
// Java Classes from the package : STS.sir.stephan.project.ix.chapter6
import sir.stephan.project.ix.chapter6.FindDiagonalOfSq;
import sir.stephan.project.ix.chapter6.FindSmallestNum;
import sir.stephan.project.ix.chapter6.InputAndFindSmallestNum;
import sir.stephan.project.ix.chapter6.FindCube;
import sir.stephan.project.ix.chapter6.FindValueOfExpression;
import sir.stephan.project.ix.chapter6.FindVelocity;
// Java Classes from the package : STS.sir.stephan.project.ix.chapter7
import sir.stephan.project.ix.chapter7.SecondSmallestNum;
import sir.stephan.project.ix.chapter7.GradeTheStudent;
import sir.stephan.project.ix.chapter7.RectangleMenu;
import sir.stephan.project.ix.chapter7.ElectricityBill;
...
public class Main2 
{
    public static void main(String[] args) 
    {
        ...
        AreaOfSquare.calculateSquare(20);   //calling method() from class AreaOfSquare
